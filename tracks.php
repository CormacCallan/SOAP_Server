...
<html>
    ...
    <body background="img/tracks.jpg">
		<div style="height:250px;">
            ...
            <tr>
                <th style="color:white;font-size: 25px;"colspan="3">Hot Tracks</th>
            </tr>
			<tr>
				<th style="padding: 15px;">Title</th>
				<th style="padding: 15px;">Artist</th>
				<th style="padding: 15px;">Total Spotify Plays</th>
            </tr>
<?php foreach ($results2 as $artist) : ?>

	            <tr>
	                
					<th style="background-color: #4ad9d9;font-size: 100%; border-radius: 20px 0 0 20px"><?php echo $artist['track_name']; ?></th>
	                <th style="background-color: #f68800;font-size: 100%;"><?php echo $artist['artist_name']; ?></th>
	                <th style="background-color: #1DB954;border-radius: 0 20px 20px 0 "><?php echo $artist['track_plays']; ?></th>
